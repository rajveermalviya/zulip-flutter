...
class _ZulipAppState extends State<ZulipApp> with WidgetsBindingObserver {
  ...
  Future<bool> didPushRouteInformation(routeInformation) async {
    switch (routeInformation) {
      case RouteInformation(uri: Uri(scheme: 'zulip', host: 'login') && var url):
        await LoginPage.handleWebAuthUrl(url);
        return true;
      case RouteInformation(uri: Uri(scheme: 'zulip', host: 'notification_open') && var url):
        ...
        return MaterialApp(
          ...
          onGenerateInitialRoutes: (initialRoute) {
            ...
            if (initialRoute != '/') {
              ...
              if (url case Uri(scheme: 'zulip', host: 'notification_open')) {
