  ...
  group('NotificationChannelManager', () {
    test('smoke', () async {
      ...
      check(testBinding.androidNotificationHost.takeCreatedChannels()).single
        ...
        // ..soundResourceUrl.equals(NotificationChannelManager.kDefaultNotificationSound)
...
extension NotificationChannelChecks on Subject<NotificationChannel> {
  ...
  Subject<String?> get soundResourceUrl => has((x) => x.soundResourceUrl, 'soundResourceUrl');
